...
if((isset($_POST['submit'])) Or (isset($_POST['submit1'])) Or (isset($_POST['submit2']))) {
    ...
    $query = mysqli_query($conn, "SELECT Photo, handle, UserID FROM profile WHERE location = '".$_POST["college"]."' OR society = '".$_POST["society"]."' OR club = '".$_POST["club"]."'") or die ("Could not search");
...
<h5 class="card-title">'.$ID.'</h5>
    <a href="../Signup/UserProfile.php?id='.$UserID.'" class="btn btn-primary" type = "submit" name="submit">View Profile</a>
