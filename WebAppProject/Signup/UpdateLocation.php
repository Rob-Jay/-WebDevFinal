...
$locationsql = "UPDATE `location` SET `LocationID`='$LocationRow',`UserID`='$UIDResult' WHERE UserID = '$UIDResult';";
...
{
    $updatelocationProfile = "UPDATE `profile` SET `location`='$LocationRow' WHERE `UserID`='$UIDResult'";
    $resupdatelocationProfile = mysqli_query($conn, $updatelocationProfile);
